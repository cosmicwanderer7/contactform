...
<option placeholder="BO">Bolivia (Plurinational State of)</option>
...
<option placeholder="IO">British Indian Ocean Territory (the)</option>
...
<option placeholder="CF">Central African Republic (the)</option>
...
<option placeholder="CC">Cocos (Keeling) Islands (the)</option>
<option placeholder="CO">Colombia</option>
<option placeholder="KM">Comoros (the)</option>
<option placeholder="CD">Congo (the Democratic Republic of the)</option>
...
<option placeholder="FK">Falkland Islands (the) [Malvinas]</option>
...
<option placeholder="TF">French Southern Territories (the)</option>
...
<option placeholder="KP">Korea (the Democratic People's Republic of)</option>
...
<option placeholder="LA">Lao People's Democratic Republic (the)</option>
...
<option placeholder="MP">Northern Mariana Islands (the)</option>
...
<option placeholder="MK">Republic of North Macedonia</option>
...
<option placeholder="SH">Saint Helena, Ascension and Tristan da Cunha</option>
...
<option placeholder="TC">Turks and Caicos Islands (the)</option>
...
<option placeholder="GB">United Kingdom of Great Britain and Northern Ireland (the)</option>
<option placeholder="UM">United States Minor Outlying Islands (the)</option>
<option placeholder="US">United States of America (the)</option>
<option placeholder="UY">Uruguay</option>
<option placeholder="UZ">Uzbekistan</option>
<option placeholder="VU">Vanuatu</option>
<option placeholder="VE">Venezuela (Bolivarian Republic of)</option>
